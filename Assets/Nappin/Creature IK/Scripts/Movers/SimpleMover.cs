...
{
    [RequireComponent(typeof(IKBody))]
    public class SimpleMover : MonoBehaviour
    {
        ...
        {
            //set vars
            IKBody bodyIK = this.GetComponent<IKBody>();
            bodyPivot = bodyIK.bodyPivot;
            directionMov = directionMov.normalized;
        ...
        private void Update()
        {
            if (canAutoMove && canWalkWall && canWalkFall) AutoMove();
            CheckFloorDistance();
        }
